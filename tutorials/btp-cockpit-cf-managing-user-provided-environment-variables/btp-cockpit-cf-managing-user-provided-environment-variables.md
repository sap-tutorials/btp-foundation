...
![Default Theme of the Sample Application](./sample-app-default-theme.png)
...
4. Go to **User-Provided Variables** in the left navigation menu.
    ...
    ![Go to User-Provided Variables](./go-to-user-provided-variables-1.png)

5. Choose **Create Variable**.

    ![Choose Create Variable](./choose-create-variable-1.png)

6. Provide a **Key** and a **Value**. These values are case-sensitive.

    ![Enter Key and Value](./enter-key-and-value-1.png)

7. Choose **Create**.

    The user-provided variable is now created.

    ![User-Provided Variable Created](./user-provided-variable-created.png)

    To apply the change, you need to restart your application.

8. Go to the **Overview** page of your application.

    ![Go to Application Overview](./user-provided-variable-created-1.png)

9. Choose **Restart**.

    ![Choose Restart](./click-app-url-1.png)

10. Click the URL of the application.

    As you can see, the interface of the app has switched to the dark theme.

    ![Dark Theme of the Sample Application](./sample-app-dark-theme.png)
...
1. On the **User-Provided Variables** page, choose the **Delete** button in the **Actions** column.
    ...
    ![Choose Delete](./choose-delete-1.png)

2. Choose **Delete** to confirm the action.

    ![Deleting a Variable](./choose-delete-3.png)
