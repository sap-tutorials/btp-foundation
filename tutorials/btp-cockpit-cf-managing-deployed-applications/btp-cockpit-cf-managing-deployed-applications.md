...
![General Information, Instances Information, Recent Logs and Events](./general-info_instances-info_logs-events.png)
...
![Starting, Stopping, Restarting, Applications](./start-stop-restart-apps-1.png)
...
![Mapped Routes Section](./mapped_routes_section.png)
...
![Sample App Home Screen](./demo-app-home-screen.png)

From **Mapped Routes**, you can map or unmap routes. To map a route:

1. Choose **Map Route**.

    ![Choose Map Route](./choose-map-route-1.png)

2. Select as many routes as you want from the list.

    ![Mapping a Route](./map-route-dialog-1.png)
...
1. In the **Instances Configuration** section, choose **Change Configuration**.
    ...
    ![Choose Change Configuration](./choose-change-configuration-1.png)

2. Add a third app instance.

    ![Change Configuration Dialog](./change-configuration-dialog-1.png)
...
3. Increase the memory per instance from 256MB to 333MB.
    ...
    **Note**: To check how much memory you can further allocate, refer to the cards **Current Application Memory Usage** and **Available Space Memory**:
    ...
    ![Current App Memory Usage and Available Space Memory](./current-app-memory-usage-and-available-space-memory-1.png)
...
![Check the Updated Configuration](./configuration-changed-1.png)
...
1. Choose **Add Instance**.
    ...
    ![Choose Add Instance](./choose-add-instance-1.png)

2. Check the added instance in the **App Instances** table.

    ![Check Added Instance](./instance-added-1.png)
...
![Choose Bind Application Autoscaler](./choose-bind-app-autoscaler-1.png)
...
![Choose Open Dasbhoard](./open-app-autoscaler-dashboard-1.png)
...
![Choose Open Application Logging Dashboard or Open Cloud Logging Dashboard](./open-app-logging-or-cloud-logging-dashboard-1.png)
...
![Choose Events](./choose-events-1.png)
